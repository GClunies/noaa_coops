...
DERIVED_PRODUCT_MATRIX =[
    pytest.param(
        ...
        "9447130",
        {"datum": "MLLW"},
        {"stationId","stationName","peakDate","peakTime","height","datum","category","event","source"},
        id="top_ten_wls",
    ),
    pytest.param(
        "extrfa",
        "1611347",
        {},
        {"rl","value","ci_low","ci_high","stationId","name","lat","lon","tidalEpoch","gridNum","gridLat","gridLong","region","startDate","endDate","validDays","totalDays","percentValidDays","probabilitiesUnit","long_term_flag","short_term_flag","localUIndex_value","localUIndex_unit","localUTrend_value","localUTrend_unit"},
        id="extrfa",
    ),
    pytest.param(
        "sealvltrends",
    ...
    pytest.param(
        ...
        "1611400",
        {"year": 2001},
        {"stnId", "stnName", "lat", "lon", "year", "majCount", "modCount", "minCount", "nanCount", "percent_completeness"},
        id="htf_annual",
    ),
